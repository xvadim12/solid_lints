...
/// AST visitor which looks for unnecessary type assertions
class AvoidUnnecessaryTypeAssertionsVisitor extends RecursiveAstVisitor<void> {
  final _expressions = <Expression, String>{};

  ///Collection of necessary type assertions
  ...
  DartType? _foundCastedTypeInObjectTypeHierarchy(
    ...
    if (objectType is InterfaceType) {
      return objectType.allSupertypes
          // ignore: deprecated_member_use
          .firstWhere((value) => value.element == castedType.element);
    }
